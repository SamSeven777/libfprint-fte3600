...
static const Fte3600GpioProfile fte3600_gpio_profiles[] = {
  ...
  {
    .sys_vendor = "GPD",
    .product_name = "Pocket 3",
    .controller_acpi_path = "\\_SB_.GPI0",
    .controller_hid = "INT34C8", /* Jasper Lake (Pentium Silver N6000) */
    .reset_offset = 211,
    .irq_offset = 56,
  },
  {
    ...
    .product_name = "Pocket 3",
    .controller_acpi_path = "\\_SB_.GPI0",
    .controller_hid = "INT3455", /* Tiger Lake-LP (Core i7-1195G7 / i3-1125G4 / 7505) */
    .reset_offset = 179,
    .irq_offset = 24,
  },
  {
    .sys_vendor = "GPD",
    .product_name = "GPD Pocket 3",
    .controller_acpi_path = "\\_SB_.GPI0",
    .controller_hid = "INT34C8",
    .reset_offset = 211,
    .irq_offset = 56,
  },
  {
...
const Fte3600GpioProfile *
fpi_fte3600_lookup_gpio_profile (const gchar *sys_vendor,
                             ...
                             GError          **error)
{
  ...
  self->gpio_profile = fpi_fte3600_lookup_gpio_profile (sys_vendor, product_name);
  ...
  for (GList *iter = gpio_devices; iter; iter = iter->next)
    {
      ...
      if (fte3600_acpi_path_equal (controller_path,
                                   self->gpio_profile->controller_acpi_path))
        {
          g_autofree gchar *hid_file =
          ...
          if (self->gpio_profile->controller_hid)
            {
              ...
              for (guint i = 0; i < G_N_ELEMENTS (fte3600_gpio_profiles); i++)
                {
                  const Fte3600GpioProfile *p = &fte3600_gpio_profiles[i];
          ...
          if (!self->init_firmware_upload_attempted)
            {
              ...
              self->firmware_bytes = fpi_fte3600_load_firmware (path, &fw_error);
